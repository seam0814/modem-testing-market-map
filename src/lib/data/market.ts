...
export const MARKET_STATS: MarketStat[] = [
  ...
  },
  {
    ...
    value: "$15B",
    unit: "USD/년",
    detail: "Starlink·Kuiper·OneWeb. 2025 ~$15B → 2030 $40B+. SpaceX Starlink 단독 매출 ~$8B (2024).",
  ...
  },
  {
    ...
    value: "$285B",
    unit: "USD/년",
    detail: "통신만이 아닌 산업 전체. 서비스 $113B (방송 $60B + 광대역 $30B + 모바일 $15B + 정부 $8B) + 지상 장비 $150B + 제조 $20B + 발사 $7B.",
    source: "SIA 2024",
    trend: "up",
  },
  {
